...
--
-- Class OrderHistory as table orderhistory
--
...
--
-- Class StoreSettings as table store_settings
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('lekhsmi_computers', '20260728153259247', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260728153259247', "timestamp" = now();
