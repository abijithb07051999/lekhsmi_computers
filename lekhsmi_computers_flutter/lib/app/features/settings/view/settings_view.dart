...
class SettingsView extends StatelessWidget {
          ...
          Expanded(
            child: LayoutBuilder(
              builder: (context, constraints) {
                ...
                final double topH = available * 0.40;
                final double botH = available * 0.60;
  ...
  // ===========================================================================
  // TOP 40% — LEKHSMI COMPUTERS STORE IDENTITY
  // ===========================================================================
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Wrap(
                            ...
                            runSpacing: 4,
                            children: [
                              _buildSyncTag('Quotation Sync',
                                  Icons.check_circle_rounded),
                              _buildSyncTag('Invoice Bill Sync',
                                  Icons.check_circle_rounded),
                              _buildSyncTag('PDF Print Ready',
                                  Icons.check_circle_rounded),
                            ],
                          ),
                        ],
                      ...
                      children: [
                        ...
                        Expanded(
                          child: _buildContactCard(
                            ...
                            subtitle:
                                'Official showroom & billing location',
  ...
  // ===========================================================================
  // BOTTOM 60% — LOOPSPRING PORTFOLIO CARD
  // Column with Expanded children — zero scrolling, everything fits.
  // ===========================================================================
                        ...
                        Expanded(
                          child: Align(
                            ...
                            child: Wrap(
                              ...
                              runSpacing: 6,
                              children: [
                                _buildSoftwareTag('CRM Software',
                                ...
                                _buildSoftwareTag('Billing Software',
        ...
        Expanded(
          ...
          child: Align(
            ...
            child: Wrap(
              ...
              children: [
                _buildContactPill(
                    Icons.language_rounded, 'www.loopspring.in'),
                _buildContactPill(
                    Icons.phone_rounded, '+91 98943 65935'),
                _buildContactPill(
                    Icons.mail_rounded, 'loopspring2@gmail.com'),
              ],
            ),
          ),
        ),
  ...
  void _showEditDialog(
    ...
    final phoneCtrl =
        TextEditingController(text: controller.storePhone.value);
    final emailCtrl =
        TextEditingController(text: controller.storeEmail.value);
    final websiteCtrl =
